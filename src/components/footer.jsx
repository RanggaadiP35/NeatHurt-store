                        ...
                        <div className="row mt-1 align-items-center">
                            {/* <div className="social-media col">
                                <div className="instagram">
                                    ...
                                    <a href="https://www.instagram.com/rangga.app/" target="_blank">
                                        rangga.app
                                    </a>
                                    <br />
                                </div>
                                <div className="threads mt-1">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width={16}
                                        height={16}
                                    ...
                                    <a href="https://www.threads.net/@rangga.app" target="_blank">
                                        rangga.app
                                    </a>
                                    <br />
                                </div>
                                <div className="github mt-1">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width={16}
                                        height={16}
                                    ...
                                    <a href="https://github.com/RanggaadiP35" target="_blank">
                                        RanggaadiP35
                                    </a>
                                </div>
                            </div> */}
                            <div className="menu col-8">
                                ...
                                <a className="nav-link" href="contacUs.html">
                                    Contact
                                </a> */}
                            </div>
                            <div className="me col">
                                <div className="row align-items-center">
                                    ...
                                    <div className="addres mt-1">
                                        ...
                                        &nbsp;
                                        <span>
                                            Jl madrasah bulu tangkis bawah kel. Pangkalan Jati
                                            Cinere-Depok
                                        </span>
                                    </div>
                                </div>
